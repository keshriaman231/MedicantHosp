...
export default function Home({ onNavigate, openAppointmentModal }: HomeProps) {
  ...
  return (
    ...
    <div className="w-full bg-[#2B87AA] text-slate-800" id="home-page-root">

      
      {/* 1. HERO BANNER CONTAINER */}
      <section className="relative -mt-[1px] bg-[#2B87AA] text-white overflow-hidden pt-4 pb-8 lg:pt-6 lg:pb-10 min-h-[460px] xl:min-h-[500px] flex items-center" id="hero-section">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#2B87AA]/40 via-transparent to-[#2B87AA]/50 z-0 pointer-events-none"></div>
            ...
            {isFullscreenVideoOpen ? (
              ...
              <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-2xl text-slate-800 flex flex-col gap-3 w-full max-w-[360px]" id="hero-notice-widget">
                <div className="flex justify-between items-center border-b border-slate-100 pb-2" id="notice-widget-header">
                  <span className="text-[#2B87AA] font-black text-xs tracking-wider uppercase flex items-center gap-1">
                    <span className="w-1.5 h-1.5 inline-block animate-ping bg-red-500 rounded-full"></span>
                    📌 Notice Board
                  </span>
                  <button onClick={() => document.getElementById('notices-section')?.scrollIntoView({ behavior: 'smooth' })} className="text-[9px] font-extrabold text-[#93E7A2] bg-green-50 px-2 py-1 rounded-lg hover:bg-green-100 flex items-center gap-0.5 cursor-pointer">
                  ...
                  <div className="flex flex-col gap-2 animate-marquee-vertical cursor-pointer">
                    {(notices || []).slice(0, 4).map((notice) => (
                      <div key={`l1-${notice.id}`} className="p-2 bg-slate-50 hover:bg-green-50/40 rounded-xl border border-slate-100 flex gap-2 transition-colors">
                        <div className="bg-[#2B87AA] text-white rounded-lg px-1.5 py-0.5 flex flex-col items-center justify-center min-w-[38px] shrink-0">
                ...
                <div className="bg-gradient-to-r from-[#93E7A2] to-[#16A34A] text-white p-3 rounded-xl flex justify-between items-center shadow-sm" id="notice-widget-promo">
                  ...
                  <button onClick={() => setIsFullscreenVideoOpen(true)} className="bg-[#93E7A2] hover:bg-[#005431] text-white px-3 py-1.5 rounded-lg text-[10px] font-black flex items-center gap-1 transition-all cursor-pointer active:scale-95 shrink-0">
      ...
      <section className="py-8 bg-[#2B87AA] text-white border-t border-white/5 relative z-20" id="stats-section">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="welcome-container">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative" id="welcome-visual">
              ...
              <div className="absolute -bottom-6 -right-6 bg-[#2B87AA] text-white p-5 rounded-2xl shadow-xl border border-slate-800 hidden sm:flex flex-col gap-1 shrink-0 max-w-[200px]" id="welcome-visual-tag">
            ...
            <div className="lg:col-span-7 flex flex-col gap-5" id="welcome-narrative">
              <span className="text-[#93E7A2] text-xs font-bold uppercase tracking-widest flex items-center gap-1.5">
                <Heart className="w-3.5 h-3.5 text-red-500 animate-pulse" /> Welcome to Medicant
              </span>
              <h3 className="text-2xl sm:text-3xl font-extrabold text-[#2B87AA] font-sans tracking-tight">
              ...
              <div className="flex gap-4 mt-2" id="welcome-narrative-actions">
                <button
                  ...
                  className="text-xs font-bold text-[#93E7A2] hover:text-[#005431] flex items-center gap-1.5 cursor-pointer border border-[#93E7A2] px-4 py-2 rounded-lg"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6" id="quick-services-grid">
            ...
            >
              <div className="flex flex-col gap-4">
                <div className="w-11 h-11 bg-green-50 rounded-xl flex items-center justify-center text-[#93E7A2] group-hover:bg-[#93E7A2] group-hover:text-white transition-colors">
                  <Search className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="font-extrabold text-sm text-[#2B87AA] mb-1">Find Specialist</h4>
                  <p className="text-xs text-slate-500 leading-normal">Search doctor listings and OPD clinic times.</p>
                </div>
              </div>
              <span className="text-xs text-[#93E7A2] font-bold flex items-center gap-1 mt-4">
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <h4 className="font-extrabold text-sm text-[#2B87AA] mb-1">Book Appointment</h4>
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <h4 className="font-extrabold text-sm text-[#2B87AA] mb-1">Medical Services</h4>
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <h4 className="font-extrabold text-sm text-[#2B87AA] mb-1">Patient Portal</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="notices-container">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10" id="notices-header-block">
            <div className="flex flex-col gap-1.5">
              <span className="text-[#93E7A2] text-xs font-bold uppercase tracking-widest">Notice Board & Announcements</span>
              <h3 className="text-2xl sm:text-3xl font-extrabold text-[#2B87AA]">Hospital Updates & Health Camps</h3>
            </div>
              ...
              >
                <div>
                  <div className="flex justify-between items-start mb-4" id="notice-card-top">
                    <span className="bg-green-50 text-[#93E7A2] border border-green-100 text-[10px] font-extrabold px-2.5 py-1 rounded-full uppercase tracking-wider">
                      {notice.category}
                    </span>
                    {notice.isNew && (
                  ...
                  <h4 className="text-sm font-extrabold text-[#2B87AA] mb-2 leading-snug">{notice.title}</h4>
      ...
      <section className="py-16 bg-white border-b border-slate-100" id="opd-calendar-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="opd-calendar-container">
          <div className="text-center mb-10" id="calendar-header-block">
            <span className="text-[#93E7A2] text-xs font-bold uppercase tracking-widest">Live OPD Scheduling</span>
            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#2B87AA] mt-1">Clinical OPD Consultation Calendar</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start" id="calendar-grid-container">
            <div className="lg:col-span-5 bg-slate-50 rounded-3xl p-6 border border-slate-100/80 shadow-sm" id="calendar-widget-card">
              <div className="flex justify-between items-center mb-6" id="calendar-month-selector">
                <span className="text-[#2B87AA] font-extrabold text-sm sm:text-base uppercase tracking-wider flex items-center gap-1.5">
                  <Calendar className="w-5 h-5 text-[#93E7A2]" /> July 2026
                </span>
                <span className="text-[10px] bg-green-50 text-[#93E7A2] px-2.5 py-1 rounded-full font-black uppercase border border-green-100">
                  Active Roster
                </span>
              </div>
                  ...
                  return (
                    <button
                      ...
                      className={`aspect-square rounded-xl font-bold flex flex-col items-center justify-center transition-all relative cursor-pointer ${isSelected
                        ? 'bg-[#93E7A2] text-white shadow-md shadow-green-100 scale-105 z-10'
                        : isSunday
                          ? 'text-red-400 hover:bg-red-50/50'
                          : 'text-[#2B87AA] bg-white border border-slate-100 hover:border-green-300 hover:text-[#93E7A2] hover:scale-105'
                        }`}
              ...
              <div className="mt-5 border-t border-slate-200/50 pt-4 flex gap-2 items-center text-[10px] text-slate-400 font-medium" id="calendar-legend">
                <span className="w-2.5 h-2.5 rounded bg-[#93E7A2]"></span> Selected
            ...
            <div className="lg:col-span-7 flex flex-col gap-4" id="calendar-roster-column">
              <div className="bg-slate-50 border border-slate-100 rounded-3xl p-5 flex flex-col sm:flex-row justify-between sm:items-center gap-3" id="calendar-roster-header">
                <div className="flex flex-col">
                  ...
                  <span className="text-base font-extrabold text-[#2B87AA]">
              ...
              <div className="flex flex-col gap-3" id="calendar-doctors-list">
                {(() => {
                  ...
                  const availableDocs = doctors.filter((doc) => {
                    if (doc.id === 'ak-singh') return dayOfWeek >= 1 && dayOfWeek <= 6;
                    if (doc.id === 'ummehani-rasool') return dayOfWeek >= 1 && dayOfWeek <= 6;
                    if (doc.id === 'majid-talikoti') return dayOfWeek >= 1 && dayOfWeek <= 5;
                    if (doc.id === 'alokr-singh') return dayOfWeek >= 1 && dayOfWeek <= 5;
                    if (doc.id === 'tm-singh') return dayOfWeek >= 1 && dayOfWeek <= 6;
                  ...
                  return availableDocs.map((doc) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                          <span className="text-[9px] bg-green-50 text-[#93E7A2] font-bold px-2 py-0.5 rounded-md uppercase tracking-wider w-fit mb-1">{doc.departmentName}</span>
                          <h4 className="text-sm font-extrabold text-[#2B87AA] leading-tight mb-0.5">{doc.name}</h4>
                          <p className="text-[10px] text-slate-400 font-medium">{doc.qualifications}</p>
                          <p className="text-xs text-[#93E7A2] font-extrabold mt-1.5 flex items-center gap-1"><Clock className="w-3.5 h-3.5" /> OPD: {doc.opdTiming}</p>
                        </div>
                      </div>
                      <button
                        type="button"
                        ...
                        className="bg-[#93E7A2] hover:bg-[#005431] text-white px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-md shadow-green-50 shrink-0 w-full sm:w-auto cursor-pointer"
                      >
                        Reserve Slot
                      </button>
                    </div>
      ...
      <section className="py-16 bg-slate-50 border-b border-slate-100 scroll-mt-24" id="virtual-tour-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="virtual-tour-container">
          <div className="flex flex-col gap-1.5 mb-8 text-center" id="tour-header-block">
            <span className="text-[#2B87AA] text-xs font-bold uppercase tracking-widest">Technological Transparency</span>
            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#2B87AA]">Explore Our Digital Clinical Spaces</h3>
          </div>
          <VirtualTour />
        </div>
      </section>
      ...
      <section className="py-16 bg-white border-b border-slate-100" id="why-choose-us-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="why-choose-us-container">
          <div className="text-center mb-12" id="why-choose-header">
            <span className="text-[#93E7A2] text-xs font-bold uppercase tracking-widest">Our Credentials</span>
            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#2B87AA] mt-1.5">What Makes Medicant Bokaro Trusted?</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" id="why-choose-grid">
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-lg transition-all flex flex-col gap-4" id="why-choose-1">
              <div className="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center text-[#93E7A2] shrink-0"><UserCheck className="w-5 h-5" /></div>
              <div><h4 className="font-extrabold text-base text-[#2B87AA] mb-1.5">Distinguished Specialists</h4><p className="text-xs text-slate-500 leading-relaxed">Our doctors represent top national institutes, carrying decades of rich clinical experience.</p></div>
            </div>
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-lg transition-all flex flex-col gap-4" id="why-choose-2">
              <div className="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center text-[#93E7A2] shrink-0"><HeartPulse className="w-5 h-5" /></div>
              <div><h4 className="font-extrabold text-base text-[#2B87AA] mb-1.5">Advanced Diagnostics</h4><p className="text-xs text-slate-500 leading-relaxed">Ultra-silent High-Tesla MRI, multi-slice fast CT, and angiography lab to enable precise diagnostics.</p></div>
            </div>
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-lg transition-all flex flex-col gap-4" id="why-choose-3">
              <div className="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center text-[#93E7A2] shrink-0"><Award className="w-5 h-5" /></div>
              <div><h4 className="font-extrabold text-base text-[#2B87AA] mb-1.5">Affordable Quality Care</h4><p className="text-xs text-slate-500 leading-relaxed">Certified quality metrics with full backing for cashless Ayushman PM-JAY and top public/private TPAs.</p></div>
            </div>
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-lg transition-all flex flex-col gap-4" id="why-choose-4">
              <div className="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center text-[#93E7A2] shrink-0"><Clock className="w-5 h-5" /></div>
              <div><h4 className="font-extrabold text-base text-[#2B87AA] mb-1.5">24/7 Critical Response</h4><p className="text-xs text-slate-500 leading-relaxed">Round-the-clock emergency, equipped trauma ambulances, continuous blood product bank and immediate triage.</p></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="departments-preview-container">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-10" id="dept-preview-header">
            <div className="flex flex-col gap-1">
              <span className="text-[#2B87AA] text-xs font-bold uppercase tracking-widest">Medical Excellence</span>
              <h3 className="text-2xl sm:text-3xl font-extrabold text-[#2B87AA]">Primary Centers of Clinical Excellence</h3>
            </div>
            <button onClick={() => onNavigate('specialities')} className="text-xs font-bold text-[#2B87AA] hover:underline flex items-center gap-1 cursor-pointer" id="dept-preview-viewall">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" id="dept-preview-grid">
            {(departments || []).slice(0, 4).map((dept) => (
              <div key={dept?.id} className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm hover:shadow-xl transition-all flex flex-col justify-between" id={`dept-card-${dept?.id}`}>
                <div className="flex flex-col gap-4">
                  <div className="w-11 h-11 bg-green-50 rounded-xl flex items-center justify-center text-[#93E7A2]"><Heart className="w-5 h-5" /></div>
                  <div>
                    <h4 className="font-extrabold text-sm text-[#2B87AA] mb-1 leading-snug">{dept?.name}</h4>
                    <span className="text-[10px] text-[#93E7A2] font-semibold tracking-wider block mb-2">{dept?.hindiName}</span>
                ...
                <div className="mt-6 pt-4 border-t border-slate-50 flex items-center justify-between" id="dept-card-actions">
                  <button onClick={() => handleDeptClick(dept?.id || "")} className="text-xs text-[#93E7A2] hover:text-[#005431] font-bold flex items-center gap-1 cursor-pointer" id={`dept-card-btn-${dept?.id}`}>
      ...
      <section className="py-12 bg-[#2B87AA] text-white" id="stats-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 lg:grid-cols-6 gap-8 text-center" id="stats-grid">
          {statistics.map((stat, idx) => (
            <div key={idx} className="flex flex-col gap-1" id={`stat-col-${idx}`}>
              <span className="text-3xl sm:text-4xl font-extrabold text-green-400">
      ...
      <section className="py-12 bg-white border-b border-slate-100" id="insurance-panel-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="insurance-panel-container">
          <div className="text-center mb-8" id="insurance-panel-header">
            <span className="text-[#93E7A2] text-xs font-bold uppercase tracking-widest">Financial Affiliation</span>
            <h4 className="text-sm font-extrabold text-[#2B87AA] uppercase tracking-wider">Approved Cashless Insurance & TPA Partners</h4>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 border border-slate-100 rounded-2xl p-5 bg-slate-50/50" id="insurance-logo-flexbox">
            ...
            <button onClick={() => onNavigate('insurance')} className="text-xs font-extrabold text-[#93E7A2] hover:underline flex items-center gap-1 cursor-pointer bg-green-50 px-3.5 py-2 rounded-xl" id="insurance-view-all-btn">
      ...
      <section className="py-16 bg-slate-50 border-b border-slate-100" id="testimonials-section">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center flex flex-col gap-6" id="testimonials-container">
          <div className="flex flex-col gap-1.5" id="testimonials-header">
            <span className="text-[#93E7A2] text-xs font-bold uppercase tracking-widest">Patient Reviews</span>
            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#2B87AA]">What our Treated Patients Say</h3>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-xl p-8 relative min-h-[220px] flex flex-col justify-between" id="testimonial-stage">
            ...
            <div className="flex flex-col gap-1" id="testimonial-author-box">
              <h5 className="font-bold text-[#2B87AA] text-sm">{testimonials[activeTestimonial].name}</h5>
              <p className="text-xs text-slate-400">{testimonials[activeTestimonial].location} • Treated in <span className="text-[#93E7A2] font-bold">{testimonials[activeTestimonial].department}</span></p>
            </div>
          </div>

          <div className="flex justify-center gap-2 mt-2" id="testimonial-dots">
            {testimonials.map((_, idx) => (
              <button key={idx} onClick={() => setActiveTestimonial(idx)} className={`w-3.5 h-3.5 rounded-full transition-all cursor-pointer ${activeTestimonial === idx ? 93E7A2] w-7' : 'bg-slate-300'}`} aria-label={`Testimonial slide ${idx + 1}`}></button>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white border-b border-slate-100" id="blogs-news-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="blogs-news-container">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-10" id="blogs-news-header">
            <div className="flex flex-col gap-1">
              <span className="text-[#93E7A2] text-xs font-bold uppercase tracking-widest">Medical Publications</span>
              <h3 className="text-2xl sm:text-3xl font-extrabold text-[#2B87AA]">Healthcare Updates & News</h3>
            </div>
            <button onClick={() => onNavigate('blog')} className="text-xs font-bold text-[#93E7A2] hover:underline flex items-center gap-1 cursor-pointer" id="blogs-news-viewall">
                ...
                <div>
                  ...
                  <div className="p-5 flex flex-col gap-2.5" id="blog-info">
                    <div className="flex justify-between items-center text-[10px] text-slate-400 font-bold" id="blog-meta-bar">
                      <span className="bg-green-50 text-[#93E7A2] px-2.5 py-0.5 rounded border border-green-100 uppercase tracking-wider">{blog?.category || "Health"}</span>
                      <span>{blog?.date}</span>
                    </div>
                    <h4 className="font-extrabold text-sm text-[#2B87AA] line-clamp-2 leading-snug">{blog?.title}</h4>
                    <p className="text-xs text-slate-500 line-clamp-2">{blog?.summary}</p>
                  </div>
                </div>
                <div className="p-5 pt-0" id="blog-action-box">
                  <button onClick={() => onNavigate('blog')} className="text-xs font-bold text-[#93E7A2] hover:underline flex items-center gap-1 cursor-pointer" id={`blog-card-btn-${blog?.id}`}>
      ...
      <section className="py-16 bg-gradient-to-r from-[#93E7A2] to-[#16A34A] text-white text-center" id="cta-banner-section">
        <div className="max-w-4xl mx-auto px-4 flex flex-col gap-5" id="cta-banner-container">
          ...
          <div className="flex justify-center gap-4 mt-2" id="cta-banner-buttons">
            <button onClick={() => openAppointmentModal()} className="bg-[#2B87AA] hover:bg-slate-900 text-white px-7 py-3.5 rounded-xl text-sm font-extrabold shadow-lg cursor-pointer" id="cta-btn-scheduler">Book Consultation Now</button>
            <a href={`tel:${hospitalInfo?.phone || "18008908898"}`} className="bg-white text-[#93E7A2] hover:bg-slate-50 px-7 py-3.5 rounded-xl text-sm font-extrabold flex items-center gap-2 shadow-lg transition-all" id="cta-btn-call"><Phone className="w-4 h-4" /> Call Helpline</a>
          </div>
        </div>
      </section>
